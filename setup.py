...
setup(name='diazoframework.bootstrap',
      version=version,
      description="A Diazo framework implementation for Twitter Bootstrap CSS",
      ...
      url='https://github.com/TH-code/diazoframework.bootstrap',
      license='GPL',
